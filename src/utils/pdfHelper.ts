...
export const generatePDFBuffer = (appointment: Appointment, scheduledAt: string) => {
  return new Promise<Buffer>((resolve, reject) => {
    ...
    doc.moveDown(0.5);
    doc.fontSize(11).fillColor("#000").text(
      "1. Appointment times may change due to emergencies; notifications will be sent.\n" +
    ...
    // Footer
    doc.moveDown(2);
    doc.fontSize(12).fillColor("#08392e").text(
      "Thank you for choosing DrConnect. Wishing you good health!",
      { align: "center" }
    );
    ...
    bufferStream.on("finish", () => {
      ...
      if (pdfBuffer) resolve(pdfBuffer);
